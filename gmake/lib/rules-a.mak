...
$(foreach f,$(SRC_C),$(eval $(call derive_rule,$(if $(OUTPUT_DIR_A_DBG),$(OUTPUT_DIR_A_DBG)/)$(call out_dir_hash,$(f)),$(f),.d,@$$(COMPILE.c) $$(CCDEPFLAGS) $$< $$(DP_OUTPUT_DIR),DEP_A_DBG)))
endif
...
$(foreach f,$(SRC_SPP),$(eval $(call derive_rule,$(if $(OUTPUT_DIR),$(OUTPUT_DIR)/)$(call out_dir_hash,$(f)),$(f),.d,@$$(COMPILE.spp) $$(SPPDEPFLAGS) $$< $$(DP_OUTPUT_DIR),DEP_A)))
endif
...
# rc
ifneq (${OUTPUT_DIR},${OUTPUT_DIR_A})
$(foreach f,$(SRC_RC),$(eval $(call derive_rule,$(if $(OUTPUT_DIR_A),$(OUTPUT_DIR_A)/)$(call out_dir_hash,$(f)),$(f),.res,$$(COMPILE.rc) $$(RC_OUTPUT_OPTION) $$<,RES)))
endif
ifneq (${OUTPUT_DIR_DBG},${OUTPUT_DIR_A_DBG})
$(foreach f,$(SRC_RC),$(eval $(call derive_rule,$(if $(OUTPUT_DIR_A_DBG),$(OUTPUT_DIR_A_DBG)/)$(call out_dir_hash,$(f)),$(f),.res,$$(COMPILE.rc) $$(RC_OUTPUT_OPTION) $$<,RES_DBG)))
endif
ifneq (${OUTPUT_DIR_STLDBG},${OUTPUT_DIR_A_STLDBG})
ifndef WITHOUT_STLPORT
$(foreach f,$(SRC_RC),$(eval $(call derive_rule,$(if $(OUTPUT_DIR_A_STLDBG),$(OUTPUT_DIR_A_STLDBG)/)$(call out_dir_hash,$(f)),$(f),.res,$$(COMPILE.rc) $$(RC_OUTPUT_OPTION) $$<,RES_STLDBG)))
endif
endif
endif
